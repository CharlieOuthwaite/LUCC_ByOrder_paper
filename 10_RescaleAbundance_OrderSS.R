...
outDir <- "10_Additional_Tests/Rescale_OrderSS/"
...
# set quantiles
# coleoptera
C_QPV <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Primary vegetation" & MeanAnomalyModelAbund_rescale$data$Order == "Coleoptera"],
  probs = exclQuantiles)
C_QSV <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Secondary vegetation" & MeanAnomalyModelAbund_rescale$data$Order == "Coleoptera"],
  probs = exclQuantiles)
C_QAL <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Agriculture_Low" & MeanAnomalyModelAbund_rescale$data$Order == "Coleoptera"],
  probs = exclQuantiles)
C_QAH <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Agriculture_High" & MeanAnomalyModelAbund_rescale$data$Order == "Coleoptera"],
  probs = exclQuantiles)

# diptera
D_QPV <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Primary vegetation" & MeanAnomalyModelAbund_rescale$data$Order == "Diptera"],
  probs = exclQuantiles)
D_QSV <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Secondary vegetation" & MeanAnomalyModelAbund_rescale$data$Order == "Diptera"],
  probs = exclQuantiles)
D_QAL <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Agriculture_Low" & MeanAnomalyModelAbund_rescale$data$Order == "Diptera"],
  probs = exclQuantiles)
D_QAH <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Agriculture_High" & MeanAnomalyModelAbund_rescale$data$Order == "Diptera"],
  probs = exclQuantiles)

# hemiptera
He_QPV <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Primary vegetation" & MeanAnomalyModelAbund_rescale$data$Order == "Hemiptera"],
  probs = exclQuantiles)
He_QSV <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Secondary vegetation" & MeanAnomalyModelAbund_rescale$data$Order == "Hemiptera"],
  probs = exclQuantiles)
He_QAL <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Agriculture_Low" & MeanAnomalyModelAbund_rescale$data$Order == "Hemiptera"],
  probs = exclQuantiles)
He_QAH <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Agriculture_High" & MeanAnomalyModelAbund_rescale$data$Order == "Hemiptera"],
  probs = exclQuantiles)

# hymenoptera
Hy_QPV <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Primary vegetation" & MeanAnomalyModelAbund_rescale$data$Order == "Hymenoptera"],
  probs = exclQuantiles)
Hy_QSV <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Secondary vegetation" & MeanAnomalyModelAbund_rescale$data$Order == "Hymenoptera"],
  probs = exclQuantiles)
Hy_QAL <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Agriculture_Low" & MeanAnomalyModelAbund_rescale$data$Order == "Hymenoptera"],
  probs = exclQuantiles)
Hy_QAH <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Agriculture_High" & MeanAnomalyModelAbund_rescale$data$Order == "Hymenoptera"],
  probs = exclQuantiles)

# lepidoptera
L_QPV <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Primary vegetation" & MeanAnomalyModelAbund_rescale$data$Order == "Lepidoptera"],
  probs = exclQuantiles)
L_QSV <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Secondary vegetation" & MeanAnomalyModelAbund_rescale$data$Order == "Lepidoptera"],
  probs = exclQuantiles)
L_QAL <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Agriculture_Low" & MeanAnomalyModelAbund_rescale$data$Order == "Lepidoptera"],
  probs = exclQuantiles)
L_QAH <- quantile(x = MeanAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MeanAnomalyModelAbund_rescale$data$LUI=="Agriculture_High" & MeanAnomalyModelAbund_rescale$data$Order == "Lepidoptera"],
  probs = exclQuantiles)
...
MeanAnomAbund_rescale <- cowplot::plot_grid(p_coleoptera,p_diptera,p_hemiptera,p_hymenoptera,p_lepidoptera)
...
# set quantiles
# coleoptera
C_QPV <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Primary vegetation" & MaxAnomalyModelAbund_rescale$data$Order == "Coleoptera"],
  probs = exclQuantiles)
C_QSV <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Secondary vegetation" & MaxAnomalyModelAbund_rescale$data$Order == "Coleoptera"],
  probs = exclQuantiles)
C_QAL <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Agriculture_Low" & MaxAnomalyModelAbund_rescale$data$Order == "Coleoptera"],
  probs = exclQuantiles)
C_QAH <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Agriculture_High" & MaxAnomalyModelAbund_rescale$data$Order == "Coleoptera"],
  probs = exclQuantiles)

# diptera
D_QPV <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Primary vegetation" & MaxAnomalyModelAbund_rescale$data$Order == "Diptera"],
  probs = exclQuantiles)
D_QSV <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Secondary vegetation" & MaxAnomalyModelAbund_rescale$data$Order == "Diptera"],
  probs = exclQuantiles)
D_QAL <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Agriculture_Low" & MaxAnomalyModelAbund_rescale$data$Order == "Diptera"],
  probs = exclQuantiles)
D_QAH <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Agriculture_High" & MaxAnomalyModelAbund_rescale$data$Order == "Diptera"],
  probs = exclQuantiles)

# hemiptera
He_QPV <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Primary vegetation" & MaxAnomalyModelAbund_rescale$data$Order == "Hemiptera"],
  probs = exclQuantiles)
He_QSV <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Secondary vegetation" & MaxAnomalyModelAbund_rescale$data$Order == "Hemiptera"],
  probs = exclQuantiles)
He_QAL <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Agriculture_Low" & MaxAnomalyModelAbund_rescale$data$Order == "Hemiptera"],
  probs = exclQuantiles)
He_QAH <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Agriculture_High" & MaxAnomalyModelAbund_rescale$data$Order == "Hemiptera"],
  probs = exclQuantiles)

# hymenoptera
Hy_QPV <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Primary vegetation" & MaxAnomalyModelAbund_rescale$data$Order == "Hymenoptera"],
  probs = exclQuantiles)
Hy_QSV <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Secondary vegetation" & MaxAnomalyModelAbund_rescale$data$Order == "Hymenoptera"],
  probs = exclQuantiles)
Hy_QAL <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Agriculture_Low" & MaxAnomalyModelAbund_rescale$data$Order == "Hymenoptera"],
  probs = exclQuantiles)
Hy_QAH <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Agriculture_High" & MaxAnomalyModelAbund_rescale$data$Order == "Hymenoptera"],
  probs = exclQuantiles)

# lepidoptera
L_QPV <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Primary vegetation" & MaxAnomalyModelAbund_rescale$data$Order == "Lepidoptera"],
  probs = exclQuantiles)
L_QSV <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Secondary vegetation" & MaxAnomalyModelAbund_rescale$data$Order == "Lepidoptera"],
  probs = exclQuantiles)
L_QAL <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Agriculture_Low" & MaxAnomalyModelAbund_rescale$data$Order == "Lepidoptera"],
  probs = exclQuantiles)
L_QAH <- quantile(x = MaxAnomalyModelAbund_rescale$data$StdTmeanAnomalyRS[
  MaxAnomalyModelAbund_rescale$data$LUI=="Agriculture_High" & MaxAnomalyModelAbund_rescale$data$Order == "Lepidoptera"],
  probs = exclQuantiles)
...
# put them all together to save them
MaxAnomAbund_rescale <- cowplot::plot_grid(p_coleoptera,p_diptera,p_hemiptera,p_hymenoptera,p_lepidoptera)
